...
export default function TShirtsPage() {
  const products = useQuery(api.products.getByCategory, { category: "t-shirts" });
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-3xl font-bold mb-8">T-SHIRTS</h1>
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-[var(--bg-secondary)] rounded-lg">
            <p className="text-[var(--text-secondary)]">No t-shirts available yet.</p>
          </div>
        ) : (
